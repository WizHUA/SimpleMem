...
class RuntimeTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_hmem_group_is_disposable_reference_view(self):
        ...
        self.assertEqual(report["mode"], "evidence_bound_maintenance")
        self.assertEqual(report["semantic_synthesis"], "extractive_with_sources")
        self.assertTrue(any(group["path"] == ["个人", "偏好", "语言"] for group in report["groups"]))
